...
LANGUAGE = {
	...
	flagPhysgun = "Toegang tot de physgun.",
	flagToolgun = "Toegang tot de toolgun.",
	flagSpawnChairs = "Toegang tot het spawnen van stoelen.",
	flagSpawnVehicles = "Toegang tot het spawnen van voertuigen.",
	flagSpawnRagdolls = "Toegang tot het spawnen van ragdolls.",
	flagSpawnProps = "Toegang tot het spawnen van props.",
	flagSpawnNPCs = "Toegang tot het spawnen van NPCs.",
