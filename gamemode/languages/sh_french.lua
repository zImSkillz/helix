...
LANGUAGE = {
	...
	flagPhysgun = "Accès au physgun.",
	flagToolgun = "Accès au toolgun.",
	flagSpawnChairs = "Accès au spawn de chaises.",
	flagSpawnVehicles = "Accès au spawn de véhicules.",
	flagSpawnRagdolls = "Accès au spawn de ragdolls.",
	flagSpawnProps = "Accès au spawn de props.",
	flagSpawnNPCs = "Accès au spawn de PNJs.",
