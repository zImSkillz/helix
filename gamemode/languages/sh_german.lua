...
LANGUAGE = {
    ...
    flagPhysgun = "Zugang zur Physgun.",
    flagToolgun = "Zugang zur Toolgun.",
    flagSpawnChairs = "Zugang zum Spawnen von Stühlen.",
    flagSpawnVehicles = "Zugang zum Spawnen von Fahrzeugen.",
    flagSpawnRagdolls = "Zugang zum Spawnen von Ragdolls.",
    flagSpawnProps = "Zugang zum Spawnen von Props.",
    flagSpawnNPCs = "Zugang zum Spawnen von NPCs.",
