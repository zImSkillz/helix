...
LANGUAGE = {
	...
	flagPhysgun = "피직스건 사용 권한.",
	flagToolgun = "툴건 사용 권한.",
	flagSpawnChairs = "의자 소환 권한.",
	flagSpawnVehicles = "차량 소환 권한.",
	flagSpawnRagdolls = "래그돌 소환 권한.",
	flagSpawnProps = "프롭 소환 권한.",
	flagSpawnNPCs = "NPC 소환 권한.",
