...
LANGUAGE = {
	...
	flagPhysgun = "Tilgang til physgun.",
	flagToolgun = "Tilgang til toolgun.",
	flagSpawnChairs = "Tilgang til å spawne stoler.",
	flagSpawnVehicles = "Tilgang til å spawne kjøretøy.",
	flagSpawnRagdolls = "Tilgang til å spawne ragdolls.",
	flagSpawnProps = "Tilgang til å spawne props.",
	flagSpawnNPCs = "Tilgang til å spawne NPCs.",
