...
LANGUAGE = {
	...
	flagPhysgun = "Dostęp do physguna.",
	flagToolgun = "Dostęp do toolguna.",
	flagSpawnChairs = "Dostęp do spawnowania krzeseł.",
	flagSpawnVehicles = "Dostęp do spawnowania pojazdów.",
	flagSpawnRagdolls = "Dostęp do spawnowania ragdolli.",
	flagSpawnProps = "Dostęp do spawnowania propsów.",
	flagSpawnNPCs = "Dostęp do spawnowania NPCów.",
