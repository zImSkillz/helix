...
LANGUAGE = {
	...
	flagPhysgun = "Acesso ao physgun.",
	flagToolgun = "Acesso ao toolgun.",
	flagSpawnChairs = "Acesso para spawnar cadeiras.",
	flagSpawnVehicles = "Acesso para spawnar veículos.",
	flagSpawnRagdolls = "Acesso para spawnar ragdolls.",
	flagSpawnProps = "Acesso para spawnar props.",
	flagSpawnNPCs = "Acesso para spawnar NPCs.",
