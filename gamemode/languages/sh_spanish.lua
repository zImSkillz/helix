...
LANGUAGE = {
	...
	flagPhysgun = "Acceso al physgun.",
	flagToolgun = "Acceso al toolgun.",
	flagSpawnChairs = "Acceso a spawnear sillas.",
	flagSpawnVehicles = "Acceso a spawnear vehículos.",
	flagSpawnRagdolls = "Acceso a spawnear ragdolls.",
	flagSpawnProps = "Acceso a spawnear props.",
	flagSpawnNPCs = "Acceso a spawnear NPCs.",
